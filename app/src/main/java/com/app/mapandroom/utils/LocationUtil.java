...
public class LocationUtil {
	...
	public static interface Listener {
		...
		/** Called whenever the device's position changes so that you can call {@link LocationUtil#getPosition()} */
	 ...
	 *
	 * @param listener the `LocationUtil.Listener` instance to attach or `null` to detach
	 */
