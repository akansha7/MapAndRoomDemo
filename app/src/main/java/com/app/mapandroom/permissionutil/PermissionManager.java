package com.app.mapandroom.permissionutil;
...
import com.app.mapandroom.utils.Constant;
...
public class PermissionManager {
     ...
     * @since : 1.0.0
     */
    public static void neverAskedDialog(final Object object, final PermissionListener listener, final ArrayList<String> neveraskedperms) {
        AlertDialog dialog = new AlertDialog.Builder(getActivity(object), R.style.MyAlertDialogStyle)
                ...
                .setNegativeButton("" + getActivity(object).getResources().getString(R.string.str_cancel), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        // Do nothing, user does not want to request
//                        listener.onPermissionNeverAsked(neveraskedperms);
    ...
    private static void openSetting(final Object object) {
        ...
        getActivity(object).startActivityForResult(i, Constant.INTENT_REQUEST_GPS);
    }
}